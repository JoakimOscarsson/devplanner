...
- Keep tracker ids, payloads, and projection states aligned with `docs/interface-catalog.md`.
...
- Do not add service logic, planner writes, or persistence code here.
